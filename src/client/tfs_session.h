...
/* Contains all information used for nameserver connection
 * Connections to the nameserver happens here.
 *
 * Note that block info is cached here!
 */
namespace tfs {
    ...
    namespace client {
        ...
        public:
            ...
            int create_block_info(uint32_t& block_id, common::VUINT64& rds, const int32_t flag,
                    common::VUINT64& fail_servers);
        ...
        private:
            ...
            int
            get_block_info_ex(uint32_t& block_id, common::VUINT64& rds, const int32_t mode, common::VUINT64& fail_ds);
