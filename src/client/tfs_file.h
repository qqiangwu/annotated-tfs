...
/* File abstraction in tfs. Important!!!
 * The real transport is happened here.
 *
 * Note that before a file is usable, the client must associate
 * a session with it.
 *
 * One can use TfsFile directly or behind TfsClient.
 *
 * Note that the real communication is done by message::Client
 */
namespace tfs
{
  namespace client
