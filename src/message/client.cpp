 ...
 *
 *
 * Version: $Id: client.cpp 49 2010-11-16 09:58:57Z zongdai@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace message {
        ...
        Message* Client::call(Message* message)
        {
            ...
            if (!ClientManager::gClientManager.connmgr_->sendPacket(ip_, send_msg, NULL,
                    reinterpret_cast<void*> (static_cast<long>(call_id_)))) {
        ...
        int post_message_to_server(const uint64_t server_id, Message* message)
        {
            ...
            // donot call the Message::buildMessage(), because cloneMessage already do that.
            if (!ClientManager::gClientManager.connmgr_->sendPacket(server_id, send_message, NULL,
                    (void*) ((long) 0))) {
