 ...
 *
 *
 * Version: $Id: client_pool.cpp 5 2010-09-29 07:44:56Z duanfei@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace message {
        ...
        SimpleAsyncClient*
        ClientManager::get_simple_async_client(const uint64_t server_id, SimpleAsyncCallback* call_back)
        {
            init();
            VUINT64 ds_list;
