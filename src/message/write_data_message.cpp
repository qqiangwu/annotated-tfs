 ...
 *
 *
 * Version: $Id: write_data_message.cpp 5 2010-09-29 07:44:56Z duanfei@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace message {
        ...
        {
            if (get_object_copy(&data, &len, reinterpret_cast<void*>(&write_data_info_), sizeof(WriteDataInfo))
                    ==TFS_ERROR) {
                return TFS_ERROR;
            }
