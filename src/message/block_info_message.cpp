 ...
 *
 *
 * Version: $Id: block_info_message.cpp 5 2010-09-29 07:44:56Z duanfei@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace message {
        ...
        BlockWriteCompleteMessage::BlockWriteCompleteMessage()
                :
                block_info_(NULL), server_id_(0), write_complete_status_(WRITE_COMPLETE_STATUS_NO),
                unlink_flag_(UNLINK_FLAG_NO)
        {
