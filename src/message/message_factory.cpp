 ...
 *
 *
 * Version: $Id: message_factory.cpp 42 2010-11-12 07:32:15Z nayan@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace message {
        ...
        int MessageFactory::send_error_message(Message* packet, int32_t level, char* file, int32_t line,
                const char* function,
