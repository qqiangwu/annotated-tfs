 ...
 *
 *
 * Version: $Id: server_status_message.h 5 2010-09-29 07:44:56Z duanfei@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace message {
        ...
        private:
            int
            set_counter_map(char** data, int32_t* len, const COUNTER_TYPE& map, int32_t from_row, int32_t return_row,
                    int32_t size);
