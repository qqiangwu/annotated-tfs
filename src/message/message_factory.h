 ...
 *
 *
 * Version: $Id: message_factory.h 42 2010-11-12 07:32:15Z nayan@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace message {
        ...
        public:
            ...
            static int
            send_error_message(Message* packet, int32_t level, char* file, int32_t line, const char* function,
