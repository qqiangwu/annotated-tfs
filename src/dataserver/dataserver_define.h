 ...
 *
 *
 * Version: $Id: dataserver_define.h 5 2010-09-29 07:44:56Z duanfei@taobao.com $
 *
 * Authors:
...
#pragma pack(4)
        ...
        public:
            ...
            MetaInfo(const uint64_t file_id, const int32_t in_offset, const int32_t file_size,
