 ...
 *
 *
 * Version: $Id: blockfile_manager.h 35 2010-11-02 07:44:51Z zongdai@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace dataserver {
        ...
        public:
            ...
            int
            get_all_logic_block(std::list<LogicBlock*>& logic_block_list, const BlockType block_type = C_MAIN_BLOCK);
            ...
            int query_bit_map(char** bit_map_buffer, int32_t& bit_map_len, int32_t& set_count,
