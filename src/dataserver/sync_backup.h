 ...
 *
 *
 * Version: $Id: sync_backup.h 5 2010-09-29 07:44:56Z duanfei@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace dataserver {
        ...
        private:
            ...
            static void
            get_backup_file_name(char* buf, const char* path, const uint32_t block_id, const uint64_t file_id);
        ...
        private:
            ...
            int remove_file(client::TfsClient* tfs_client, const uint32_t block_id, const uint64_t file_id,
                    const int32_t undel);

            int rename_file(client::TfsClient* tfs_client, const uint32_t block_id, const uint64_t file_id,
