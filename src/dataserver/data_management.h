 ...
 *
 *
 * Version: $Id: data_management.h 33 2010-11-01 05:24:35Z nayan@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace dataserver {
        ...
        public:
            ...
            int init_block_files(const common::SysParam::FileSystemParam& fs_param);
            ...
            int
            query_bit_map(const int32_t query_type, char** tmp_data_buffer, int32_t& bit_map_len, int32_t& set_count);
