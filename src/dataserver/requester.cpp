 ...
 *
 *
 * Version: $Id: requester.cpp 5 2010-09-29 07:44:56Z duanfei@taobao.com $
 *
 * Authors:
                ...
                if (EXIT_NO_LOGICBLOCK_ERROR==ret) {
                    ...
                    if (NULL==blk) {
                        ...
                        TBSYS_LOG(
                                ...
                                blk->block_id_, blk->version_, blk->file_count_, blk->size_, blk->del_file_count_,
                                blk->del_size_, blk->seq_no_);
                    }
                }
            }
