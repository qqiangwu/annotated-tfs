 ...
 *
 *
 * Version: $Id: meta_manager.h 15 2010-10-12 04:56:17Z chuyu@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace nameserver {
        ...
        public:
            ...
            // handle blocks
            int report_blocks(const uint64_t ds_id, const std::vector<common::BlockInfo>& blocks,
        ...
        private:
            ...
            uint32_t
            register_expire_block(EXPIRE_BLOCK_LIST& expireList, const uint64_t ds_id, const uint32_t block_id);
