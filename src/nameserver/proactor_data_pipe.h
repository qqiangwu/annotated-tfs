 ...
 *
 *
 * Version: $Id: proactor_data_pipe.h 5 2010-09-29 07:44:56Z duanfei@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace nameserver {
        ...
        ProactorDataPipe<Container, Executor>::ProactorDataPipe()
                :
                tbsys::CDefaultRunnable(), executor_(NULL), args_(NULL), speed_(false), wait_for_finish_(false),
                wait_time_(0),
        ...
        ProactorDataPipe<Container, Executor>::ProactorDataPipe(Executor* executor, int32_t thread_count, void* args)
                :
                tbsys::CDefaultRunnable(thread_count), executor_(executor), args_(NULL), speed_(false),
                wait_for_finish_(false),
