 ...
 *
 *
 * Version: $Id: strategy.h 5 2010-09-29 07:44:56Z duanfei@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace nameserver {
        ...
        int32_t elect_replicate_source_ds(const vector<ServerCollect*>& ds_list,
                const ReplicateStrategy::counter_type& src_counter, const int32_t elect_count,
                common::VUINT64& elect_ds_list);
        ...
        bool
        elect_move_dest_ds(const vector<ServerCollect*>& ds_list, const ReplicateStrategy::counter_type& dest_counter,
