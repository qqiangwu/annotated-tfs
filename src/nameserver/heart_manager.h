...
namespace tfs {
    namespace nameserver {
        ...
        class MasterAndSlaveHeartManager
                : public ProactorDataPipe<std::deque<message::Message*>, MasterAndSlaveHeartManager> {
            template<typename Container, typename Executor> friend
            class ProactorDataPipe;
