 ...
 *
 *
 * Version: $Id: block_collect.h 5 2010-09-29 07:44:56Z duanfei@taobao.com $
 *
 * Authors:
...
namespace tfs {
    namespace nameserver {
        ...
        public:
            BlockCollect()
                    :
                    master_ds_(0), last_leave_time_(0), last_join_time_(0), load_error_(0),
                    creating_flag_(BLOCK_CREATE_FLAG_NO)
            {
